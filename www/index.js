$(document).ready(function () {
    var chack = 0;
    var firebaseUrl = "https://psupin-54346.firebaseio.com/";
    //register
        ...
        $.getJSON("http://localhost:3000/regis", function (data) {
            for (i = 0; i < data.length; i++) {
                if (id_post == data[i].id) {
                    ...
                    $("#show_post").prepend("<ul class=\"list-group\">");
                    $("#show_post").prepend("<li class=\"list-group-item\">comment : "+ comment +"</li>");
                    $("#show_post").prepend("<li class=\"list-group-item\" align = \"center\"><img id=\"img_post_show\" src=" + image + "></li>");
                    $("#show_post").prepend("<li class=\"list-group-item\">"+ data[i].name +"</li>");
                    $("#show_post").prepend("</ul>");
